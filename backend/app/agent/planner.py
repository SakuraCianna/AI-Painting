...
def _tree_objects(index: int, x: int, y: int) -> list[AgentSceneObject]:
    ...
    return [
        _object(
            ...
            "rect",
            f"树干{index}",
            {"x": x + 30, "y": y + 100, "width": 34, "height": 108, "radius": 10},
            "#9a6a3a",
            stroke="#5f3b18",
            stroke_width=3,
            layer_id="middle",
        ...
        objects.append(
            _object(
                ...
                "草地",
                {
                    "commands": [
                        {"cmd": "M", "x": 0, "y": 452},
                        {"cmd": "C", "x1": 150, "y1": 425, "x2": 260, "y2": 468, "x": 386, "y": 444},
                        {"cmd": "C", "x1": 550, "y1": 412, "x2": 682, "y2": 468, "x": 820, "y": 438},
                        {"cmd": "C", "x1": 930, "y1": 415, "x2": 992, "y2": 440, "x": 1024, "y": 428},
                        {"cmd": "L", "x": 1024, "y": 768},
                        {"cmd": "L", "x": 0, "y": 768},
                        {"cmd": "Z"},
                    ]
    ...
    if _has_open_scene_item(text, "太阳"):
        objects.append(
            _object(
                ...
                "star",
                "太阳光芒",
                {"cx": 850, "cy": 130, "outerRadius": 92, "innerRadius": 70, "points": 12},
                "#fde68a",
                stroke="#fde68a",
                stroke_width=0,
                layer_id="background",
        ...
        objects.append(
            _object(
                ...
                "弯曲小路",
                {
                    "commands": [
                        {"cmd": "M", "x": 430, "y": 768},
                        {"cmd": "C", "x1": 468, "y1": 675, "x2": 480, "y2": 575, "x": 502, "y": 455},
                        {"cmd": "C", "x1": 540, "y1": 548, "x2": 582, "y2": 656, "x": 632, "y": 768},
                        {"cmd": "Z"},
                    ]
                },
                "#f5e6c8",
        ...
        objects.extend(
            [
                ...
                _object(
                    ...
                    "rect",
                    "小屋木门",
                    {"x": 158, "y": 486, "width": 42, "height": 84, "radius": 8},
                    "#8b5e34",
                    stroke="#5f3b18",
                    stroke_width=3,
                    layer_id="middle",
                    group_id="open-house",
                    semantic_tags=["house", "house.door", "landscape"],
                    z_index=36,
                ),
                _object(
                    "open-house-window",
                    "rect",
                    "小屋窗户",
                    {"x": 212, "y": 464, "width": 34, "height": 34, "radius": 6},
                    "#bfdbfe",
                    stroke="#1e3a8a",
                    stroke_width=3,
                    layer_id="middle",
                    group_id="open-house",
                    semantic_tags=["house", "house.window", "landscape"],
                    z_index=37,
                ),
            ]
        )
...
def _local_scene_graph_for_text(normalized_text: str) -> AgentSceneGraph | None:
    plantuml_scene_graph = build_plantuml_scene_graph(normalized_text)
    if plantuml_scene_graph is not None:
        return plantuml_scene_graph
