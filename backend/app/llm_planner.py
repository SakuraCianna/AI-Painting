    ...
    return [
        {
            ...
            "content": (
                ...
                "你只能使用这些操作: create_canvas,add_object,set_style,set_style_many,set_metadata,set_metadata_many,move_object,move_many,scale_object,scale_many,replace_shape,replace_shape_many,generate_image_asset,delete_object,clear_canvas,save_artwork,export_artwork,undo,redo。"
